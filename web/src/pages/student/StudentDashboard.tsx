          ...
          <Card title="Testing Progress" icon={<Star className="h-5 w-5" />}>
            <div className="rounded-xl bg-emerald-50/60 ring-1 ring-emerald-200/60 p-4">
              ...
              <div className="mt-1 text-lg text-slate-800">
                On Track <span className="text-emerald-700">↗</span>
              </div>
            ...
            <div className="mt-3 text-sm text-slate-500">
              You’re above this year’s benchmark. 🎉
            </div>
          </Card>
        </div>
          ...
          <ShellCard>
            <div className="p-6">
              ...
              <div className="mt-5 grid grid-cols-1 gap-4 md:grid-cols-4">
                <SubjectMini
                  title="Math"
                  note="Up since last test ↗"
                  bgClass="bg-emerald-50/60"
                  barClass="bg-emerald-500"
                />
                <SubjectMini
                  title="Reading"
                  note="Dropped slightly 💧"
            ...
            <div className="p-6">
              ...
              <div className="mt-5 grid grid-cols-1 gap-4 md:grid-cols-2">
                <TodoItem
                  ...
                  text={
                    <>
                      Practice reading <span className="font-semibold">15 minutes daily</span> 📖
                    </>
                  }
                />
                <TodoItem
                ...
                <TodoItem
                  ...
                  text={<>Aim for perfect attendance this week ✅</>}
                />
              </div>
            </div>
          </ShellCard>
